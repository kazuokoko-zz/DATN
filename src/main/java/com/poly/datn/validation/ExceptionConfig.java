...
//
//import com.poly.datn.validation.common.response.ErrorResponse;
//import com.poly.datn.validation.common.response.ValidationErrorResponse;
...
//  @ResponseBody
//  ErrorResponse onNotFoundException(IllegalArgumentException e) {
//    ErrorResponse error = new ErrorResponse();
//    setErrorInfo(error, "API-003", e.getMessage());
//    return error;
//  }
//
//  @ExceptionHandler(IdE.class)
//  @ResponseStatus(HttpStatus.NOT_FOUND)
//  @ResponseBody
