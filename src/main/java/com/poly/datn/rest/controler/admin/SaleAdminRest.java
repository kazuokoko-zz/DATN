...
public class SaleAdminRest {
    ...
    @PostMapping("newSale")
    public ResponseEntity<ResponseDTO<Object>> newSale(SaleVO saleVO,Principal principal) {
    ...
    @PutMapping("stopSale")
    public ResponseEntity<ResponseDTO<Object>> stopSale(Integer id, Principal principal) {
