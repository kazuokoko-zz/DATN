...
public class OrdersRest {
    ...
    public List<Orders> getList(@PathVariable("id") Integer id, @PathVariable("u") String u) {
        return ordersService.getByUsername(u);
    }

    @GetMapping("{id}/cutomer/{u}/{oid}")
    public Orders getOrders(@PathVariable("id") Integer id, @PathVariable("u") String u, @PathVariable("oid") Integer oid) {
